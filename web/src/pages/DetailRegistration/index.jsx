        ...
        <PageContainer loading={pageLoading}>
            {notFound ? (
                ...
                <>
                    <Row gutter={24}>
                        <Col lg={14} sm={24}>
                            <Card title={<Typography.Text strong>Chi tiết xe</Typography.Text>} style={{ height: '100%', minHeight: '400px'}}>
                                <CarDetail car={registration}></CarDetail>
                            </Card>
                        </Col>
                        <Col lg={10} sm={24}>
                            <Card title={<Typography.Text strong>Chủ sở hữu</Typography.Text>} style={{ height: '100%', minHeight:'400px' , overflow:'initial'}}>
                    ...
                    <Row style={{ paddingTop: '24px' }}>
                        <Col span={24}>
                            <Card title={<Typography.Text strong>Lịch sử</Typography.Text>} style={{ height: '400px' }}>
                                <History history={registration.history}></History>
                            </Card>
                        </Col>
                    </Row>
                </>
